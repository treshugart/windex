!function(factory) {
  ...
  Windex.prototype = {
    ...
    request: function(url, data) {
      ...
      if (data && type !== 'GET' && typeof this.headers['Content-Type'] === 'undefined') {
    ...
    serialize: function(obj) {
      if (typeof this.serializers[this.headers['Content-Type']] === 'function') {
        return this.serializers[this.headers['Content-Type']](obj);
      }
